...
import { FaLinkedin, FaInstagram, FaYoutube, FaTelegramPlane } from "react-icons/fa";
      ...
      <div className="hidden md:flex flex-row w-full">
          ...
          <div className="flex space-x-3 -mt-5">
            ...
            <div>
              <div className="space-y-3">
                <h1 className="text-[24px] custom-md3:text-[26px] font-inter font-bold leading-[1.2]">
                  CODERS AND <br />
                  DEVELOPERS CLUB
                </h1>
                <p className="font-inter font-semibold text-[18px] custom-md3:text-[16px] leading-[1.2]">
        ...
        <div className="flex justify-center w-full md:w-[40%] custom-md3:w-[35%] ">
          <div className="-mt-5 w-full">
            <h3 className="font-inter text-[16px] custom-md3:text-[18px] font-bold mb-[6%] text-center ">
              NAVIGATION
            </h3>
        ...
        <div className="w-full md:w-[22%] custom-md3:w-[27%] flex justify-center">
          <div className="-mt-5 ">
            <h3 className="font-inter text-[16px] custom-md3:text-[18px] font-bold mb-[28%] text-center ">
              REACH US
            </h3>
            <div className="grid grid-cols-2 gap-[40%] text-white text-3xl">
              <div className="w-[40px] cursor-pointer transition-transform duration-300 hover:scale-125">
                <a href="https://www.linkedin.com/company/codechef-mmmut-chapter/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                  <FaLinkedin />
                </a>
              </div>
              <div className="w-[40px] cursor-pointer transition-transform duration-300 hover:scale-125">
                <a href="http://www.youtube.com/@cdcmmmut" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                  <FaYoutube />
                </a>
              </div>
              <div className="w-[40px] cursor-pointer transition-transform duration-300 hover:scale-125">
                <a href="https://www.instagram.com/cdc.mmmut/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                  <FaInstagram />
                </a>
              </div>
              <div className="w-[40px] cursor-pointer transition-transform duration-300 hover:scale-125">
                <a href="https://t.me/+q7L9GAuUxoNiMjZl" target="_blank" rel="noopener noreferrer" aria-label="Telegram">
                  <FaTelegramPlane />
                </a>
              </div>
            </div>
      ...
      <div className="md:hidden flex flex-col w-full">
        <div className="flex space-x-3 -mt-5">
          ...
          <div>
            <div className="space-y-2">
              ...
              <p className="font-inter text-[18px] custom-md3:text-[22px] leading-[1.2]">
                Madan Mohan Malaviya University of
                <br />
                Technology,
                <br />
        ...
        <div className="flex flex-row mt-10 w-full justify-center">
          ...
          <div className="w-[30%] justify-items-center">
            ...
            <div className="grid grid-cols-2 gap-[30%] w-[80%] justify-items-center text-white text-3xl">
              <div className="w-[30px] sm:w-[40px] cursor-pointer transition-transform duration-300 hover:scale-125">
                <a href="https://www.linkedin.com/company/codechef-mmmut-chapter/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                  <FaLinkedin />
                </a>
              </div>
