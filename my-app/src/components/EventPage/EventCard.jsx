...
const EventCard = ({event}) => {
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row font-inter font-medium text-white mt-6 mx-4 md:ml-14 md:mr-14 rounded-2xl h-auto">
      {/* Event Image */}
      <div className="flex-shrink-0 md:w-auto w-full flex justify-center items-center mr-8 md:h-80 h-auto">
        <img src={event.image} alt="event" className="md:w-auto h-72 w-auto object-contain" />
      </div>
      ...
      <div className="flex-1 ml-0 md:ml-6 mt-6 md:mt-0">
        {/* Description Section */}
        <div className="mt-4">
          <h3 className="text-white bg-white/15 pt-1 pb-1 font-inter text-2xl font-bold w-full md:w-48 text-center rounded-xl">
            Description
          </h3>
        ...
        <div className="flex flex-wrap justify-between mt-12">
          ...
          <div className="w-full md:w-auto mb-6 md:mb-0">
            <h4 className="text-white bg-white/15 pt-1 pb-1 font-inter text-xl font-bold w-full md:w-3/5 text-center rounded-xl">Schedule</h4>
          ...
          {/* Venue */}
          <div className="w-full md:w-auto mb-6 md:mb-0">
            <h4 className="text-white bg-white/15 pt-1 pb-1 font-inter text-xl font-bold w-full md:w-3/6 text-center rounded-xl">Venue</h4>
          ...
          <div className="w-full md:w-auto">
            <h4 className="text-white bg-white/15 pt-1 pb-1 font-inter text-xl font-bold w-full md:w-40 text-center rounded-xl">Registeration</h4>
